---
source_url: https://docs.aspose.com/slides/python-net/3d-presentation/
extracted_date: 2025-07-21T13:36:09.761289
---

# Create 3D Presentations in Python
...
- [depth](https://reference.aspose.com/slides/python-net/aspose.slides/ithreedformat/),
  [extrusion\_color](https://reference.aspose.com/slides/python-net/aspose.slides/ithreedformat/)
  and [extrusion\_height](https://reference.aspose.com/slides/python-net/aspose.slides/ithreedformat/): are used to make the shape three-dimension, which means to convert a 2D shape into a 3D shape,
  by setting its depth or extrusing it.
- [light\_rig](https://reference.aspose.com/slides/python-net/aspose.slides/ithreedformat/): can create a light effect on a 3D shape. The logic of this property is closed to Camera, you can set the rotation of the light
...
and [extrusion\_color.color](https://reference.aspose.com/slides/python-net/aspose.slides/ithreedformat/) properties:
